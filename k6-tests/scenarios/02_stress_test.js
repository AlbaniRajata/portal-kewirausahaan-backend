...
export const options = {
  ...
  thresholds: {
    ...
    "http_req_duration{name:public_berita}": ["p(95)<2000"],
    "http_req_duration{name:auth_login}": ["p(95)<12000"],
    "http_req_duration{name:mahasiswa_profile}": ["p(95)<2000"],
    "http_req_duration{name:mahasiswa_tim_status}": ["p(95)<2000"],
    "http_req_duration{name:mahasiswa_proposal_status}": ["p(95)<2000"],
    "http_req_duration{name:mahasiswa_pembimbing_dosen}": ["p(95)<2000"],
    "http_req_duration{name:mahasiswa_bimbingan}": ["p(95)<2000"],
    "http_req_duration{name:admin_profile}": ["p(95)<2000"],
    "http_req_duration{name:admin_proposal}": ["p(95)<2000"],
    "http_req_duration{name:reviewer_profile}": ["p(95)<2000"],
    "http_req_duration{name:dosen_bimbingan_pengajuan}": ["p(95)<2000"],
    "http_req_duration{name:juri_penugasan}": ["p(95)<2000"],
  },
};
